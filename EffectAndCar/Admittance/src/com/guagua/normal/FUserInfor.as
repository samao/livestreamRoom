package com.guagua.normal
{
	...
	public class FUserInfor extends EventDispatcher
	{
		 ...
		 * <tr><td>obj.m_lCarID:车辆图片id</td></tr></table>,
		 * */
		public function FUserInfor(obj:Object,target:IEventDispatcher=null)
		{
			super(target);
			try{
		 ...
		 * @private
		 */
		public function set texture(value:DisplayObject):void
		{
			isReady=true;
			_texture = value;
		}
